        ...
        <div class="content-view__feedback-card user__search-wrapper">
            <div class="feedback-card__top">
                <div class="user__search-icon">
                    ...
                    <span><?php echo count($user->tasks) . ' ' . \Htmlacademy\logic\PluralForms::pluralNouns(count($user->tasks), 'задание', 'задания','заданий'); ?></span>
                    <span><?php echo count($user->reviews) . ' ' . \Htmlacademy\logic\PluralForms::pluralNouns(count($user->reviews), 'отзыв','отзыва','отзывов'); ?></span>
                </div>
                <div class="feedback-card__top--name user__search-card">
                    ...
                    <b>
                        ...
                        if ($rates !== 0 && count($user->reviews) !== 0) {
                            echo round($rates/count($user->reviews),2);
                        }
                        ?>
                    </b>
