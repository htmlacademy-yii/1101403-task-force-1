...
CREATE TABLE users (
    ...
    message_alert   TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
    action_alert    TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
    review_alert    TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
    show_contacts   TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
    show_profile    TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
...
CREATE TABLE alerts (
    id              INT UNSIGHNED NOT NULL AUTO_INCREMENT,
    user_id         INT UNSIGHNED NOT NULL,
    reply_id        INT UNSIGHNED,
    task_id         INT UNSIGHNED NOT NULL,
    message_id      INT UNSIGHNED,
    note_type       ENUM('answer', 'message', 'refuse', 'start', 'finish') NOT NULL,
    is_new          TINYINT(1) UNSIGHNED DEFAULT 1 NOT NULL,
    dt_create       TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    PRIMARY KEY (id),
